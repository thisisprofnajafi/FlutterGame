            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                  ...
                  <span class="d-flex">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link link-disabled" href="index2.html#" aria-expanded="false">
                  <span class="d-flex">
                    <i class="ti ti-ban"></i>
                  </span>
                  ...
                  <span class="d-flex">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link justify-content-between" href="index2.html#" aria-expanded="false">
